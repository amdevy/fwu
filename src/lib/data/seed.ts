...
const seeds: DesignerSeed[] = [
  ...
  { id: 'shevstudio', slug: 'shevstudio', name: { ua: 'Shevstudio', en: 'Shevstudio' }, brand: 'Shevstudio', city: { ua: 'Україна', en: 'Ukraine' }, founded: 2026, discipline: { ua: '—', en: '—' }, lede: { ua: 'Опис буде додано.', en: 'Description coming soon.' }, quote: { ua: '', en: '' } },
  ...
  { id: 'zlatich', slug: 'zlatich', name: { ua: 'Zlatich', en: 'Zlatich' }, brand: 'Zlatich', city: { ua: 'Україна', en: 'Ukraine' }, founded: 2026, discipline: { ua: '—', en: '—' }, lede: { ua: 'Опис буде додано.', en: 'Description coming soon.' }, quote: { ua: '', en: '' } },
  ...
  { id: 'tonicdevie', slug: 'tonicdevie', name: { ua: 'Tonicdevie', en: 'Tonicdevie' }, brand: 'Tonicdevie', city: { ua: 'Україна', en: 'Ukraine' }, founded: 2026, discipline: { ua: '—', en: '—' }, lede: { ua: 'Опис буде додано.', en: 'Description coming soon.' }, quote: { ua: '', en: '' } },
  { id: 'brenzovych', slug: 'brenzovych', name: { ua: 'Брензович', en: 'Brenzovych' }, brand: 'Брензович', city: { ua: 'Україна', en: 'Ukraine' }, founded: 2026, discipline: { ua: '—', en: '—' }, lede: { ua: 'Опис буде додано.', en: 'Description coming soon.' }, quote: { ua: '', en: '' } },
  { id: 'cheypesh', slug: 'cheypesh', name: { ua: 'Чейпеш', en: 'Cheypesh' }, brand: 'Чейпеш', city: { ua: 'Україна', en: 'Ukraine' }, founded: 2026, discipline: { ua: '—', en: '—' }, lede: { ua: 'Опис буде додано.', en: 'Description coming soon.' }, quote: { ua: '', en: '' } },
