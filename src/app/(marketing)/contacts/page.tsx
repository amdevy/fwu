          ...
          <div className="grid gap-16 lg:grid-cols-2">
            ...
            <ScrollReveal>
              ...
              <div className="mt-8 space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-medium text-black">Адреса</p>
                    <p className="mt-1 text-sm text-sage">
                      м. Ужгород, вул. Корзо, 10<br />
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-medium text-black">Соціальні мережі</p>
            ...
            <ScrollReveal delay={0.2}>
              <div className="bg-white p-6 md:p-8">
                <h3 className="font-heading text-2xl text-black">Напишіть нам</h3>
